                    ...
                    <Card style={{ width: '40rem' }} >
                        <Card.Body className="card-body">
                            ...
                            <button className="button-help" onClick={function (event) {
                                ...
                                setDescText("À partir de l'ongler \"Accueil\", cliquez sur le bouton \"Importer une configuration\" et sélectionnez la configuration que vous souhaitez utiliser sur votre appareil.");
                                togglePopupHelp();
                            ...
                            <button className="button-help" onClick={function (event) {
                                ...
                                setDescText("Dans l'onglet \"Résultats\", repérez le résultat que vous souhaitez consulter en fonction de la configuration utilisée, du type de plaque examiné, de la date et de l'action effectuée. Cliquez sur le bouton correspondant à cette configuration dans la colonne de droite (en forme de loupe) pour consulter les résultats de l'opération choisie.");
                                togglePopupHelp();
                            }}>
                    ...
                    <Card style={{ width: '40rem' }} >
                        <Card.Body className="card-body">
                            ...
                            <button className="button-help" onClick={function (event) {
                                ...
                                setDescText("Une fois que la configuration est réglée selon vos besoins à partir de l'ongler \"Accueil\", il suffit de cliquer sur le bouton \"Sauvegarder comme Config Défaut\" pour en faire la nouvelle configuration par défaut.");
                                togglePopupHelp();
                    ...
                    <Card style={{ width: '40rem' }} >
                        <Card.Body className="card-body">
                            ...
                            <button className="button-help" onClick={function (event) {
                                ...
                                setDescText("À partir de l'onglet \"Accueil\", choisir le pôle à évaluer dans le menu déroulant, puis cliquer sur le bouton play (la flèche verte). L'évaluation peut être mise sur pause grâce au bouton bleu, ou arrêtée grâce au bouton rouge.");
                                togglePopupHelp();
